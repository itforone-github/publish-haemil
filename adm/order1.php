...
?>
    ...
    <section class="order1">
        <div class="panel">
            ...
            <span>
            <button type="button" class="btn btn_blue btn_sdw"  >선택 복용법 발행</button>
            ...
            <div  class="table adm">
                <table class="">
                    ...
                    <tr>
                        ...
                        <td class="" rowspan="2"><button type="button" class="btn btn_whiteline" onclick="location.href='order.prescribe1.done.php'">수정</button><button type="button" class="btn btn_redline">취소</button></td>
                    </tr>
                    <tr>
