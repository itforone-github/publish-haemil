...
<section class="px pre2">
    <div class="left">
            ...
            <div class="box2 packing">
                ...
                <div class="box_line1">
                    ...
                    <ul class="flex flexwrap circle">
                        <li>
                            ...
                            <input type="radio" id="pack1-1" name="pack1" /> <label for="pack1-1"> 45팩 박스</label>
                        </li>
                        <li>
                            <div class="thumb_img" style="background-image: url(../img/common/noimg.png)"></div>
                            <input type="radio" id="pack1-2" name="pack1" /> <label for="pack1-2"> 60팩 박스</label>
                        </li>
                    </ul>
                </div>
                <div class="box_line2">
                ...
                <div class="box_line2">
                    ...
                    <input type="checkbox" id="print1" name="print" /> <label for="print1"> 없음</label>
                    <input type="checkbox" id="print2" name="print" /> <label for="print2"> 한의원명</label>
                    <input type="checkbox" id="print3" name="print" /> <label for="print3"> 환자명</label>
                    <input type="checkbox" id="print4" name="print" /> <label for="print4"> 조제일자</label>
                    <input type="checkbox" id="print5" name="print" /> <label for="print5"> 연락처</label>
                </div>
                <div class="box_line2">
                    <p class="tit">달이는 시간 <span>달이는 시간을 선택해 주세요.</span></p>
                    <span class="circle">
                    <input type="radio" id="time1" name="time" /> <label for="time1"> 1시간 30분</label>
                    <input type="radio" id="time2" name="time" /> <label for="time2"> 2시간</label>
                    <input type="radio" id="time3" name="time" /> <label for="time3"> 3시간</label>
                    </span>
                </div>
            </div>
    </div>
    <div class="right">
            <div class="sticky">
                ...
                <a class="btn w100 btn_red btn_order">수정 및 재결제</a>
            </div>
    </div>
</section>
