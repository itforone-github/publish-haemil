...
<section class="readymadeupd">
    ...
    <div class="box3">
        ...
        <div class="box_line2">
            ...
            <p class="line"><label>처방집명</label><input type="text" placeholder="처방집명을 입력하세요" /></p><br>
            <p class="line"><label>산출물</label><select><option>탕전처방</option><option>환제처방</option><option>산제처방</option></select></p><br>
            <p class="line"><label>참고사항</label><textarea placeholder="참고사항을 입력하세요" class="w100"></textarea></p>
        </div>
    </div>
    </div>
</section>
